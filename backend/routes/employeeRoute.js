...
// https://school-manage-ment.onrender.com/api/v2/employees/single
router.get("/single/:_id",isSignIn,singleEmployeeController);
// https://school-manage-ment.onrender.com/api/v2/employees/single
router.put("/update/:_id",isSignIn,updateEmployeeController);
// https://school-manage-ment.onrender.com/api/v2/employees/department/:_id
router.get("/department/:_id",isSignIn,getEmployeeByDeptId);
// https://school-manage-ment.onrender.com/api/v2/employees/salary
